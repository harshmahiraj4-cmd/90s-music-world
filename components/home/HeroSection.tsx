...
export default function HeroSection() {
  ...
  return (
    <section className="relative px-4 pt-4 pb-6 overflow-hidden">
      ...
      <div className="relative bg-surface-container-low/90 rounded-xl p-4 sm:p-6 shadow-2xl backdrop-blur-2xl overflow-hidden">
        {/* Top badge */}
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8 md:items-center">
          ...
          <div className="relative my-3 md:my-0 flex items-center justify-center md:order-2">
            <div className="relative w-44 h-44 sm:w-52 sm:h-52 flex items-center justify-center">
              ...
              <div className="absolute inset-0 rounded-full bg-surface-container-lowest p-2 shadow-2xl shadow-primary-container/30 flex items-center justify-center animate-spin-slow">
                <div className="w-full h-full rounded-full flex items-center justify-center relative"
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-tr from-primary-container to-secondary-container/60 p-1 flex items-center justify-center shadow-lg">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-surface-container-lowest flex items-center justify-center">
              ...
              <div className="relative z-10 w-36 h-24 sm:w-40 sm:h-28 rounded-lg bg-surface-container-high/90 backdrop-blur-md p-2 shadow-xl flex flex-col justify-between" style={{ transform: 'rotate(-6deg)' }}>
          ...
          {/* Text & CTAs */}
          <div className="text-center md:text-left mt-2 md:mt-0 md:order-1 flex flex-col justify-center">
            <h1 className="font-playfair text-headline-lg-mobile md:text-headline-lg text-on-surface font-bold tracking-tight">
              WELCOME TO{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-tertiary to-secondary">
                90s MUSIC WORLD
              </span>
            </h1>
            <p className="font-sans text-title-md md:text-title-lg text-secondary-fixed-dim mt-1">Relive the Golden Era of Music</p>
            <p className="font-sans text-body-sm md:text-body-md text-on-surface-variant mt-2 max-w-sm md:max-w-none mx-auto md:mx-0 line-clamp-3">
            ...
            {/* CTA buttons */}
            <div className="mt-4 grid grid-cols-2 gap-2 sm:max-w-md mx-auto md:mx-0">
              <button
              ...
              <a
                href="/discover"
                className="flex items-center justify-center gap-1.5 py-3 px-4 rounded-xl bg-surface-container-high/80 hover:bg-surface-container-highest text-on-surface font-sans text-title-md font-medium shadow-md transition-all active:scale-95 text-center"
              >
